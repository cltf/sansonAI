...
window.changeSlide = function(direction) {
    ...
    if (direction === 1) {
        ...
        currentSlideIndex = currentSlideIndex === 0 ? carouselItems.length - 1 : currentSlideIndex - 1;
    }
    
    showSlideGlobal(currentSlideIndex, carouselItems, indicators);
    resetAutoSlide();
};
...
window.currentSlide = function(index) {
    ...
    currentSlideIndex = index - 1; // 转换为0基索引
    showSlideGlobal(currentSlideIndex, carouselItems, indicators);
    resetAutoSlide();
};

// 全局显示幻灯片函数
function showSlideGlobal(index, carouselItems, indicators) {
    // 隐藏所有轮播项
